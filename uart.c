  ...
  )
{
  ...
  BRGCON = 0x00;
  BRGR0 = 0xF0; //Low byte of baud rate - 752 machine cycles
  BRGR1 = 0x02; //High byte of baud rate
  BRGCON = 0x03;
...
void uart_isr(void) interrupt 4 using 1
{
  if (RI)
  {
	...
	greenLED = ~ greenLED; //Flip the status LED
